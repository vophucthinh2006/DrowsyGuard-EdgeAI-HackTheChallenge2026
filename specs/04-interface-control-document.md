...
| Transceiver | VCS: **on-board TJA1057GTK/3Z** (FRDM-MCXN947 has one wired to header J10, confirmed against the board schematic — no external part needed). DMS: 3.3 V CAN transceiver (e.g. SN65HVD230 / TJA1051T/3), external, per OI-04-05 | |
